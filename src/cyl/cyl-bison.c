...
{
  "$end", "error", "$undefined", "COLON", "FILETYPE", "LOWER_WORD", "NL",
  "PATTERN", "UPPER_WORD", "WS", "$accept", "stmt", "filetype", "variable",
  "grammar", YY_NULLPTR
};
#endif
...
{
       1,     4,     5,     6,     7,    10,     0,     8,    16,    12,
      11,    13,    14,     0,    17,    18,     0,    19
};
...
{
       0,     4,    11,    12,     3,     0,     6,     9,     8,    13,
       5,     9,     6,     7,     5,    14,     3,     6,     9,     8
};
